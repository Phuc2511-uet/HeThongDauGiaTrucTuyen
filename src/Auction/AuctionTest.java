...
public class AuctionTest {
    ...
    void setUp() {
        ...
        seller = new Seller("S01", "Nguyen Van A", "sellera", "123", "Seller A", 5.0);
        bidder1 = new Bidder("B01", "Tran Van B", "bidderb", "123", "Bidder B", 5000.0);
        bidder2 = new Bidder("B02", "Le Thi C", "bidderc", "123", "Bidder C", 5000.0);
