...
public class AuctionWonController implements Observer {
    ...
    public void initialize() {
        ...
        Client.getInstance().getObservers().removeIf(obs -> obs instanceof AuctionWonController);
    ...
    public void update(String message) {
        Platform.runLater(() -> {
            ...
            if (message.startsWith("PAY_SUCCESS")) {
                ...
                Client.getInstance().send("GET_CURRENT_USER"); // Cập nhật lại số dư hiển thị của Bidder
    ...
    private HBox createAuctionWonCard(int auctionId, String itemName, double winPrice, String status) {
        ...
        if ("PAID".equals(status)) {
            ...
            payBtn.setOnAction(e -> {
                Client.getInstance().send("PAY " + auctionId);
            });
        }
