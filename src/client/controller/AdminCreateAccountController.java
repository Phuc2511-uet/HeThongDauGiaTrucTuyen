...
public class AdminCreateAccountController implements Observer {
    ...
    public void initialize() {
        // Dọn dẹp Observer
        ClientConnection.getInstance().getObservers().clear();
    ...
    private void handleCreate() {
        ...
        ClientConnection.getInstance().send(cmd);
    }

    @FXML
    private void back() {
        HomeAdminController.setPage("/client/view/resources/fxml/adminListUser.fxml");
    }
