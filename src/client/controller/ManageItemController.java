...
public class ManageItemController implements Observer {
    ...
    private void loadItems() {
        ...
        ClientConnection.getInstance().getMyItems();
    }
    ...
    private void openDetail(int itemId) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/view/resources/fxml/itemDetailSeller.fxml"));
    ...
    private void createAuction(int itemId, double itemPrice) {
        ClientConnection.getInstance().createAuction(String.valueOf(itemId), "0", itemPrice);
    }
    private void deleteItem(int itemId) {
        ClientConnection.getInstance().sellerDeleteItem(itemId);
    }

    @FXML
    private void openCreateItemPage() {
        HomeSellerController.setPage("/client/view/resources/fxml/createItem.fxml");
    }
}