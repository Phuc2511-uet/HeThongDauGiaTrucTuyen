...
public class AdminListAuctionController implements Observer {
    ...
    private void loadAuctions() {
        ...
        ClientConnection.getInstance().send("GET_AUCTIONS");
    }
            ...
            if (cleanMessage.startsWith("LIST_AUCTION")) {
                ...
                for (int i = 1; i < parts.length; i++) {
                    ...
                    try {
                        ...
                        ClientConnection.getInstance().send("GET_AUCTION_BY_ID " + auctionId);
                    } catch (Exception e) {
    ...
    private HBox createAuctionCard(int id, String itemName, String seller, String status, String bidder, double currentPrice) {
        ...
        switch (status) {
            ...
            case "RUNNING":
                ...
                cancelBtn.setOnAction(e -> ClientConnection.getInstance().send("CANCEL_AUCTION " + id));
            ...
            case "CANCELED":
                ...
                restoreBtn.setOnAction(e -> ClientConnection.getInstance().send("RESTORE_AUCTION " + id));
                break;
