...
public class SigninController {
    ...
    void signinAccount(ActionEvent event) {
        ...
        if (selectedRole != null) {
            ClientConnection.getInstance().newAccount(user, pass, selectedRole, fullname);
        }
    }
    ...
    void returnLogin(ActionEvent event) {
        try {
            Parent returnRoot = FXMLLoader.load(getClass().getResource("/client/view/resources/fxml/login.fxml"));
