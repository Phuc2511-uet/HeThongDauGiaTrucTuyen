...
import shared.model.auction.AuctionModel;
        ...
        tblAuctions.setRowFactory(tv -> {
            ...
            row.setOnMouseClicked(event -> {
                if (event.getClickCount() == 1 && (!row.isEmpty())) {
                    ...
                    ClientConnection.selectedAuctionId = rowData.getId();
                    HomeBidderController.setPage("/client/view/resources/fxml/auctionDetail.fxml");
                }
            });
            return row;
        });
