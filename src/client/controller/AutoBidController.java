...
public class AutoBidController {
    ...
    private void handleActivateAutoBid() {
        ...
        try {
            ...
            // 3. KIỂM TRA LOGIC NGHIỆP VỤ ĐẤU GIÁ VỚI BIẾN CỦA ClientConnection
            ...
            // Khớp hàm lấy số dư thực tế từ class ClientConnection của bạn: ClientConnection.getInstance().getCurrentBalance()
            double userBalance = ClientConnection.getInstance().getCurrentBalance();
            ...
            //  "AUTO_BID <auction_id> <max_bid> <increment>"
            String message = "AUTO_BID " + auctionId + " " + maxBid + " " + increment;
            ClientConnection.getInstance().send(message);
