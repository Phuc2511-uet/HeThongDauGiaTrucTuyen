...
public class AdminListItemController implements Observer {
    ...
    public void initialize() {
        ClientConnection.getInstance().getObservers().removeIf(obs -> obs instanceof AdminListItemController);
    ...
    private void loadItems() {
        ...
        ClientConnection.getInstance().getItemIds();
    }
            ...
            if (cleanMessage.startsWith("ITEM_IDS")) {
                ...
                for (int i = 1; i < parts.length; i++) {
                    try {
                        ...
                        ClientConnection.getInstance().getItemById(itemId);
                    } catch (Exception e) {
    ...
    private HBox createItemCard(int itemId, String itemName, String itemType, double itemPrice, boolean hasAuction) {
        ...
        if (hasAuction) {
            ...
            deleteBtn.setOnAction(e -> ClientConnection.getInstance().deleteItem(itemId));
