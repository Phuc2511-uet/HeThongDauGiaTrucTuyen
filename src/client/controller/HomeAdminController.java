...
public class HomeAdminController {
    ...
    @FXML
    void showInfoAdmin() {
        setPage("/client/view/resources/fxml/adminInfo.fxml");
    }

    @FXML
    void showListUser() {
        setPage("/client/view/resources/fxml/adminListUser.fxml");
    }


    @FXML
    void showListItem() {
        setPage("/client/view/resources/fxml/adminListItem.fxml");
    }

    @FXML
    void showListAuction() {
        setPage("/client/view/resources/fxml/adminListAuction.fxml");
    }
