...
public class ManageAuctionController implements Observer {
    ...
    private void loadAuctions() {
        ...
        ClientConnection.getInstance().getSellerAuctions();
    }
    ...
    private void openDetail(int auctionId) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/view/resources/fxml/auctionDetailSeller.fxml"));
