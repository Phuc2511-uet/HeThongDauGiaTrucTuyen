...
public class AdminListUserController implements Observer {
    ...
    public void initialize() {
        ...
        ClientConnection.getInstance().getObservers().removeIf(obs -> obs instanceof AdminListUserController);
    ...
    private void loadUsers() {
        ...
        ClientConnection.getInstance().getUserIds();
    }
            ...
            if (message.startsWith("USER_IDS")) {
                ...
                for (int i = 1; i < parts.length; i++) {
                    try {
                        ...
                        ClientConnection.getInstance().getUserById(userId);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    private void handleAdminCreateAccount() {
        HomeAdminController.setPage("/client/view/resources/fxml/adminCreateAccount.fxml");
    }
    ...
    private HBox createUserCard(
        ...
        deleteBtn.setOnAction(e -> {
            ClientConnection.getInstance().deleteUser(id);
        });
