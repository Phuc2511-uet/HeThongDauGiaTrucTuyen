...
public class MainFx extends Application {
    ...
    public static void showHomeByRole(String role) {
        try {
            ...
            switch (role.toUpperCase()) {
                case "BIDDER":
                    fxmlPath = "/client/view/resources/fxml/homeBidder.fxml";
                    title += " Bidder";
                    break;
                case "SELLER":
                    fxmlPath = "/client/view/resources/fxml/homeSeller.fxml";
                    title += " Seller";
                    break;
                case "ADMIN":
                    fxmlPath = "/client/view/resources/fxml/homeAdmin.fxml";
                    title += " Admin";
                    break;
                default:
    ...
    public static void showLoginScene() {
        try {
            FXMLLoader loader = new FXMLLoader(MainFx.class.getResource("/client/view/resources/fxml/login.fxml"));
            Parent root = loader.load();
            mainStage.hide();
    ...
    public static void showSignInScene() {
        try {
            FXMLLoader loader = new FXMLLoader(MainFx.class.getResource("/client/view/resources/fxml/signin.fxml"));
            Parent root = loader.load();
    ...
    public void start(Stage stage) throws Exception {
        ...
        mainStage = stage;
        // 1. Khởi động ClientConnection ở thread riêng
        startClient();
        ...
        mainStage.getIcons().add(new Image(getClass().getResourceAsStream("/client/view/resources/images/icon.png")));
        try {
            // Nạp file FXML từ thư mục resources/fxml
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/client/view/resources/fxml/login.fxml"));
            Parent root = loader.load();
