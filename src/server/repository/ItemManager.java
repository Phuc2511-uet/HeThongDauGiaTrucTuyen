...
import shared.model.item.factory.ArtCreator;
import shared.model.item.factory.ElectronicCreator;
import shared.model.item.factory.ItemFactory;
import shared.model.item.factory.VehicleCreator;
...
public class ItemManager implements Serializable {
    ...
    public synchronized void remove(int id) {
        ...
        if (isDeletedInDB) {
            ...
            // Chặn lại, không cho items.removeIf chạy để tránh hiện tượng mất ảnh ảo trên UI ClientConnection
        }
    }
