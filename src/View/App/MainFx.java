...
public class MainFx extends Application {
    ...
    public static void showHomeByRole(String role) {
        try {
            ...
            switch (role.toUpperCase()) {
                case "BIDDER":
                    fxmlPath = "/View/resources/fxml/homeBidder.fxml";
                    title += " Bidder";
                    break;
                case "SELLER":
                    fxmlPath = "/View/resources/fxml/homeSeller.fxml";
                    title += " Seller";
                    break;
                case "ADMIN":
                    fxmlPath = "/View/resources/fxml/homeAdmin.fxml";
                    title += " Admin";
                    break;
                default:
    ...
    public static void showLoginScene() {
        try {
            FXMLLoader loader = new FXMLLoader(MainFx.class.getResource("/View/resources/fxml/login.fxml"));
            Parent root = loader.load();
            mainStage.hide();
    ...
    public static void showSignInScene() {
        try {
            FXMLLoader loader = new FXMLLoader(MainFx.class.getResource("/View/resources/fxml/signin.fxml"));
            Parent root = loader.load();
    ...
    public void start(Stage stage) throws Exception {
        ...
        mainStage.getIcons().add(new Image(getClass().getResourceAsStream("/View/resources/images/icon.png")));
        try {
            // Nạp file FXML từ thư mục resources/fxml
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/resources/fxml/login.fxml"));
            Parent root = loader.load();
